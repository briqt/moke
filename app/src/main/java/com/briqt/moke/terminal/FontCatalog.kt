...
data class FontSpec(
    ...
    /** 一句话说明的字符串资源 id（0=没有）。放资源里而不是内联中文，英文界面才看得到。 */
...
object FontCatalog {
    ...
    val all: List<FontSpec> = listOf(
        FontSpec(
            ...
            ligature = true,
            noteRes = R.string.font_note_jetbrains_mono,
        ),
        FontSpec(
            id = "noto_sans_sc",
            name = "Noto Sans SC",
        ...
        FontSpec(
            ...
            ligature = true,
            noteRes = R.string.font_note_fira_code,
        ),
        FontSpec(
            id = "maple_mono",
            ...
            noteRes = R.string.font_note_maple_mono,
        ),
        FontSpec(
            id = "hack",
            name = "Hack",
            ...
            noteRes = R.string.font_note_hack,
        ),
        FontSpec(
            ...
            noteRes = R.string.font_note_ibm_plex_mono,
        ),
        FontSpec(
            ...
            noteRes = R.string.font_note_source_code_pro,
        ),
        FontSpec(
            ...
            noteRes = R.string.font_note_roboto_mono,
        ),
        FontSpec(
            ...
            noteRes = R.string.font_note_ubuntu_mono,
        ),
        FontSpec(
            ...
            noteRes = R.string.font_note_inconsolata,
        ),
        FontSpec(
            ...
            noteRes = R.string.font_note_space_mono,
        ),
        FontSpec(
            ...
            noteRes = R.string.font_note_anonymous_pro,
        ),
        FontSpec(
            ...
            ligature = true,
            noteRes = R.string.font_note_cascadia_code,
        ),
        FontSpec(
            ...
            ligature = true,
            noteRes = R.string.font_note_jetbrains_mono_nerd_font,
        ),
        FontSpec(
            ...
            ligature = true,
            noteRes = R.string.font_note_victor_mono,
        ),
        FontSpec(
